	...
	*/
	...
	public static function custom_post_types() {
		...
		$cptLabels = array(
				...
				'search_items'          => __( "Search {$single}", 'text_domain' ),
			...
			$cptArgs = array(
				...
				'description'           => __( "Printable {$plural}", 'text_domain' ),
				...
				'rewrite'               => array( 'slug' => 'sv-crm', 'with_front' => false ),
				'show_ui'               => true,
				'show_in_menu'          => true,
			...
			register_post_type( $cpt_name, $cptArgs );
	}
	*/
	...
	public function add_acf_fields() {
		...
		acf_add_local_field_group(array (
          ...
          'media_upload' => 1,
				...
				/*
				array(
					'key' => 'field_5e84fac46b02a',
					'label' => '<span class="dashicons dashicons-tag"></span> Taxonomy',
					'name' => '',
					'type' => 'tab',
					'instructions' => '',
					'required' => 0,
	...
	public function run_bulk_coupons() {
		...
		// TODO: make a log for this

		$coupons = sv_api_connection('getCoupons')['COUPONS']['COUPON'];
